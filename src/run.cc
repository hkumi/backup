...
MyRunAction::MyRunAction()
{
   ...
   // man->CreateNtupleDColumn("fT");
    ...
    man->CreateH2("a1 ","angle vs energy_1", 100, 0, 2, 100, 0, 2.0);
    man->CreateH2("a2 ","angle vs energy_2", 100, 0, 2, 100, 0, 2.0);
    man->CreateH2("a3 ","angle vs energy_3", 100, 0, 2, 100, 0, 2.0);
    man->CreateH2("a4 ","angle vs energy_4", 100, 0, 2, 100, 0, 2.0);
    man->CreateH2("a5 ","angle vs energy_5", 100, 0, 2, 100, 0, 2.0);
    man->CreateH2("a6 ","angle vs energy_6", 100, 0, 2, 100, 0, 2.0);
    man->CreateH2("a7 ","angle vs energy_7", 100, 0, 2, 100, 0, 2.0);
    man->CreateH2("a8 ","angle vs energy_8", 100, 0, 2, 100, 0, 2.0);
    man->CreateH2("a9 ","angle vs energy_9", 100, 0, 2, 100, 0, 2.0);
    man->CreateH2("a10 ","angle vs energy_10", 100,0,2, 100, 0, 2.0);
